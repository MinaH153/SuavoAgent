...
{
    private void ApplyPricingAuthorityTerminalAckMigration()
    {
        ApplyMigrationIfNeeded(38,
            "Allow exact PHI-free pricing-authority terminal ACKs",
            """
            CREATE TABLE pricing_terminal_ack_outbox_v38 (
            ...
            INSERT INTO pricing_terminal_ack_outbox_v38 (
            ...
            ALTER TABLE pricing_terminal_ack_outbox_v38
