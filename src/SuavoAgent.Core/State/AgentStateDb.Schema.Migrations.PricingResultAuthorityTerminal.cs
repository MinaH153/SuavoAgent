...
{
    private void ApplyPricingResultAuthorityTerminalMigration()
    {
        ApplyMigrationIfNeeded(37,
            "Allow exact local pricing-authority terminal result receipts",
            """
            ...
            ALTER TABLE pricing_result_outbox_terminal_receipts
                RENAME TO pricing_result_outbox_terminal_receipts_v37;
            ...
            SELECT job_id, payload_sha256, reason_code, http_status, response_json,
                response_sha256, response_key_id, response_signature,
                quarantined_at
              FROM pricing_result_outbox_terminal_receipts_v37;
            DROP TABLE pricing_result_outbox_terminal_receipts_v37;
