...
{
    private void ApplyPricingTerminalAckOutboxMigration()
    {
        ApplyMigrationIfNeeded(26,
            "PHI-free durable pricing terminal failure ACK outbox",
            """
            CREATE TABLE pricing_terminal_ack_outbox (
                ...
                mode TEXT CHECK(mode IS NULL OR mode IN ('sql','uia')),
